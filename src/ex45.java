...
// 구현 : 건축에서 시공사의 역할, 실제 기능구현은 코드(Coder)가 구현한다.
...
class Picasso extends Picture {
    ...
    @Override
    void draw() {
        System.out.println("Picasso가 그림을 그린다.");
    }
}
...
class SuperPicasso extends Picture {
    ...
    @Override
    void draw() {
        System.out.println("Super ~~ Picasso가 그림을 그린다.");
    }
}
public class ex45 {
    public static void main(String[] args) {
        SuperPicasso picasso = new SuperPicasso();
        picasso.draw();
    }
}
